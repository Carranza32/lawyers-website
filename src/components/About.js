      ...
      <div id="aboutUs" className="container mt-5">
         <div className="row clearfix">
            <div className="col-md-6 col-sm-12">
               <img src={window.location.origin + '/assets/images/lawyersCircle.png'} alt="about us" className="img-fluid"/>
            </div>
            <div className="col-md-6 col-sm-12 m-auto">
               <div className="ms-5 align-middle">
                  <p className="border-left-color display-6 ">Circa noi</p>
                  <p className="text-justify">Il nostro gruppo coinvolge più persone competenti e motivate, che forniscono maggiori risorse, idee ed energie rispetto ad una sola persona.
